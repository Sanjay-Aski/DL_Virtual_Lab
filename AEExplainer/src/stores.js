...
export const isInBottleneckStore = writable(false);
export const bottleneckDetailViewStore = writable({});
export const isInDecoderStore = writable(false);
export const decoderDetailViewStore = writable({});
